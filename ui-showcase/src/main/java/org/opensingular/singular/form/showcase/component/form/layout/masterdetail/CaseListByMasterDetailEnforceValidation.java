 ...
 */
@CaseItem(componentName = "List by Master Detail", subCaseName = "Validar elemento antes de adicionar", group = Group.LAYOUT,
        resources = {@Resource(STypeExperienciaProfissional.class), @Resource(CaseLayoutPackage.class)})
@SInfoType(spackage = CaseLayoutPackage.class, name = "EnforceValidationMasterDetail")
public class CaseListByMasterDetailEnforceValidation extends STypeComposite<SIComposite> {

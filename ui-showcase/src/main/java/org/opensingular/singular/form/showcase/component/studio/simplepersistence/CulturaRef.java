...
@SInfoType(name = "CulturaRef", spackage = CulturaPackage.class)
public class CulturaRef extends STypeRef<SIComposite> {
	...
	protected String getDisplayValue(SIComposite instance) {
		return instance.getValue(STypeCultura.class, c -> c.nome);
	}
	...
	protected void onLoadType(@Nonnull TypeBuilder tb) {
		...
		display.asSQL().foreignColumn("NO_CULTURA", "CO_CULTURA", STypeCultura.class);
	}
}

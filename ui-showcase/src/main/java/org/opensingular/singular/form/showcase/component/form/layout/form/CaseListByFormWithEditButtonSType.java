 ...
 * List by Form
 */
@CaseItem(componentName = "List by Form", subCaseName = "Botão de inserção por elemento", group = Group.LAYOUT,
        resources = {@Resource(STypeExperienciaProfissional.class), @Resource(CaseLayoutPackage.class)})
@SInfoType(spackage = CaseLayoutPackage.class, name = "EditButton")
public class CaseListByFormWithEditButtonSType extends STypeComposite<SIComposite> {
